# [Учебный репозиторий к задаче 4](https://github.com/netology-code/virtd-homeworks/blob/shvirtd-1/05-virt-04-docker-in-practice/README.md)
...
#### * В проекте отсутствует env файл с переменным окружением для старта образа mysql:8, также отсутствует его пример. Файл env формируется автоматически при использовании bash скрипта auto-deploy.sh. При использовании auto-deploy необходимо скопировать на целевую рабочею станцию до момента клонирования репозитория.  
